      ...
      <>
        ...
        <Modal show className="drawer" backdropClassName="drawer-backdrop" backdrop="static" onHide={this.hide}>
          <Modal.Header closeButton>
            <Modal.Title>{_t('style.title')}</Modal.Title>
          </Modal.Header>
          <Modal.Body>
