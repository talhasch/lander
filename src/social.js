...
export const accountTypes = [
  ...
  {id: 'twitter', name: 'Twitter', 'icon': twitterSvg, label: 'twitter.com/', placeholder: 'username', defVisible: true},
  {id: 'facebook', name: 'Facebook', 'icon': facebookSvg, label: 'facebook.com/', placeholder: 'username', defVisible: true},
  {id: 'instagram', name: 'Instagram', 'icon': instagramSvg, label: 'instagram.com/', placeholder: 'username', defVisible: true},
